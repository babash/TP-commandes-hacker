...
Une **fiche professeur** complète (corrigé détaillé, conseils pédagogiques, points d'attention par question) est disponible dans ce dépôt : [`fiche_prof_mirage.html`](https://github.com/babash/TP-commandes-hacker/blob/main/fiche_prof_mirage.html)
